...
const uint16_t PROGMEM tab_combo[] = {KC_O, KC_I, COMBO_END}; // LAYER1 L2_K1 + L2_K2
const uint16_t PROGMEM ffive_reload_combo[] = {KC_U, KC_G, COMBO_END}; // LAYER1 L1_K3 + L1_K4

const uint16_t PROGMEM reset_keyboard_left_combo[] = {KC_J, KC_M, KC_C, COMBO_END}; // LAYER1 L1_K3 + L1_K4 + L1_K5
const uint16_t PROGMEM reset_keyboard_right_combo[] = {KC_B, KC_P, KC_W, COMBO_END}; // LAYER1 L1_K3 + L1_K4 + L1_K5

//Layer2

// layer3

//const uint16_t PROGMEM cancel_combo[] = {KC_LEFT, KC_HOME, COMBO_END}; // LAYER2 l2_K1 + L2_K2
const uint16_t PROGMEM close_window_combo[] = {KC_T, KC_PGDN, COMBO_END}; // LAYER2 L1_K4 + L1_K5
const uint16_t PROGMEM reopen_closed_tab_combo[] = {KC_T, KC_PGDN, KC_UP, COMBO_END}; // LAYER2 L1_K3 + L1_K4 + L1_K5
